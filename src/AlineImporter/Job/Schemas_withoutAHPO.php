	...
	'Rapport de thèse' => [
		...
		'propertySchemas'=> [
			...
			'dcterms:created'=>[
				...
				'valueColumn' => 'date'],
			'dcterms:isPartOf'=>[
				[ //Publication, à revoir ehp:publishedIn
				'type' => 'literal',
				'valueColumn' => 'pb'],
				[
				...
				'foreignTable' => 'hprptphd',
				'schemaIndex' => 'Volume'],
				[ //endroit dans les archives, à revoir ehp:classificationNumber
				'type' => 'literal',
				'valueColumn' => 'ident'],
				[ //à revoir, curate=conserver ehp:archivedAt
				'type' => 'resource',
				'foreignTable' => 'archives',
				'schemaIndex' => 'Lieu d’archives',
				'foreignKeyColumn' => 'scid'],],
			...
			'dcterms:identifier'=>[
				'type' => 'literal',
				'valueColumn' => 'bibkey'],
			'dcterms:type'=>[ //à revoir ehp:documentType
				'type' => 'literal',
				'valueColumn' => 'type'],
			'dm2e:writer'=>[
				'type' => 'resource',
